       ...
       <?php the_post_thumbnail(); ?>
        ...
        <div class="social-media">
          <?php if( get_theme_mod( 'multipurpose_portfolio_facebook_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'multipurpose_portfolio_facebook_url','' ) ); ?>"><i class="fab fa-facebook-f"></i><span class="screen-reader-text"><?php esc_html_e( 'Facebook', 'multipurpose-portfolio' ); ?></span></a>
          <?php } ?>
          <?php if( get_theme_mod( 'multipurpose_portfolio_twitter_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'multipurpose_portfolio_twitter_url','' ) ); ?>"><i class="fab fa-twitter"></i><span class="screen-reader-text"><?php esc_html_e( 'Twitter', 'multipurpose-portfolio' ); ?></span></a>
          <?php } ?>
          <?php if( get_theme_mod( 'multipurpose_portfolio_insta_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'multipurpose_portfolio_insta_url','' ) ); ?>"><i class="fab fa-instagram"></i><span class="screen-reader-text"><?php esc_html_e( 'Instagram', 'multipurpose-portfolio' ); ?></span></a>
          <?php } ?>
          <?php if( get_theme_mod( 'multipurpose_portfolio_pinterest_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'multipurpose_portfolio_pinterest_url','' ) ); ?>"><i class="fab fa-pinterest-p"></i><span class="screen-reader-text"><?php esc_html_e( 'Pinterest', 'multipurpose-portfolio' ); ?></span></a>
          <?php } ?> 
          <?php if( get_theme_mod( 'multipurpose_portfolio_youtube_url') != '') { ?>
            <a href="<?php echo esc_url( get_theme_mod( 'multipurpose_portfolio_youtube_url','' ) ); ?>"><i class="fab fa-youtube"></i><span class="screen-reader-text"><?php esc_html_e( 'Youtube', 'multipurpose-portfolio' ); ?></span></a>
          <?php } ?>
        </div>
      <?php  endwhile; ?>
      <?php else : ?>
    ...
    <section id="services">
      <div class="container">
        <?php if( get_theme_mod('multipurpose_portfolio_services_title') != ''){ ?>
          <h2><?php echo esc_html(get_theme_mod('multipurpose_portfolio_services_title','')); ?></h2>
        <?php }?>
        <div class="row">
          <?php 
